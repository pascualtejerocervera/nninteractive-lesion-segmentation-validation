...
if TYPE_CHECKING:
    from nnInteractive_v1.inference.inference_session import nnInteractiveInferenceSession

REPO_ID = "nnInteractive/nnInteractive"
MODEL_NAME = "nnInteractive_v1.0"  # Updated models may be available in the future

class NNInteractiveV1Model():
    def __init__(
        self,
        device: str,
        use_memory: bool,
    ...
    def _initialize_model(
        ...
        from nnInteractive_v1.inference.inference_session import nnInteractiveInferenceSession  # Import 
